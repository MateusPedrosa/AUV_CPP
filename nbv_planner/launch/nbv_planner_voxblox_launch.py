...
def generate_launch_description():
    ...
    declare_voxels_per_side = DeclareLaunchArgument(
        'voxels_per_side',
        default_value='16',
        description='Voxels per side'
    )
    ...
    declare_truncation_distance = DeclareLaunchArgument(
        'truncation_distance',
        default_value='0.4',
        description='Truncation distance for point cloud data'
    )

    declare_max_weight = DeclareLaunchArgument(
        'max_weight',
        default_value='10000.0',
        description='Maximum weight for voxel updates'
    )
    ...
    # NBV Planner Node
    nbv_planner_node_voxblox = Node(
        package='nbv_planner',
        executable='nbv_planner_node_voxblox',
        name='nbv_planner',
        ...
        parameters=[
            {
                ...
                'voxels_per_side': LaunchConfiguration('voxels_per_side'),
                ...
                'truncation_distance': LaunchConfiguration('truncation_distance'),
                'max_weight': LaunchConfiguration('max_weight'),
            },
